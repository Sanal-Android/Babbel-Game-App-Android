package com.team.smileapplication.utils.widget
...
class LoadingButton @JvmOverloads constructor(
    ...
    init {
        ...
        if (boldText) {
            mTextPaint.typeface = ResourcesCompat.getFont(context, R.font.roboto_bold)
            mTextPaint.isFakeBoldText = true
        } else {
            mTextPaint.typeface = ResourcesCompat.getFont(context, R.font.roboto_medium)
